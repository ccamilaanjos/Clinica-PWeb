package com.pweb.endereco.models;
...
public class Endereco {
	...
	public Endereco(EnderecoPostDTO endereco) {
		this.logradouro = refinarLogradouro(endereco.logradouro());
		this.numero = refinarNumero(endereco.numero());
		this.complemento = refinarComplemento(endereco.complemento());
		this.bairro = refinarBairro(endereco.bairro());
		this.cidade = refinarCidade(endereco.cidade());
		this.uf = refinarUF(endereco.uf());
